...
const Driverform1=()=>{
    ...
    const checkbox=(e)=>{
      ...
      const handleSubmit=(e)=>{
        ...
        setdriverdetails({...driverdetails,id:id,vehicle_type:vehicletype});
        ...
        <form  className="ml-4 pt-4">
          ...
          <label>भाडामा दिने गाडीको मोडल (Vehicle Model)</label><br/>
           ...
           <input
            ...
            required
          /><br/>
          <button type="submit" onClick={(e)=>handleSubmit(e)} className="btn-success btn">Submit</button><br/>
